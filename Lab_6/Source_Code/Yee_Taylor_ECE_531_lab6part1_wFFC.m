...
for k=1:frameSize:numSamples*filterUpsample
    ...
    rmsEVM(timeIndex) = evm(correctedPhaseEstimate(timeIndex));
    ...
    if visualOffsetCorrected
        ...
        step(sa,[coarseCorrectedData(timeIndex),fineCorrectedData(timeIndex)]);pause(0.1); %#ok<*UNRCH>
        % Visualize Corrected Data
